...
namespace SprykerSdk\Yves\Benchmark\Plugin\Console;
...
/**
 * @method \SprykerSdk\Yves\Benchmark\BenchmarkFactory getFactory()
 */
class BenchmarkRunConsole extends Console
{
    public const COMMAND_NAME = 'benchmark:run';
    public const COMMAND_DESCRIPTION = 'Will run Yves test using phpbench framework';
